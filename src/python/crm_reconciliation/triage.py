...
def triage_ledger(
    ...
    marketing_context = (
        ...
        .select(
            "marketing_record_id",
            pl.col("name")
            .alias("marketing_name"),
            pl.col("email")
            .alias("marketing_email"),
            pl.col("phone")
            .alias("marketing_phone"),
        )
    )
    ...
    result = (
        ...
        .with_columns(
            ...
            (
                pl.col("_name_lower")
                .str.contains(
                    r"promotional contact"
                )
                | pl.col("_email_lower")
                .str.contains(
                    r"^promo\d*@"
                )
                | pl.col("_phone_digits")
                .str.starts_with(
                    "210555"
                )
            )
        ...
        .with_columns(
            ...
            .then(
                pl.lit(
                    "retain_as_unmatched_acquisition"
                )
            )
            ...
            .then(
                pl.lit(
                    "exclude_from_marketing_reconciliation"
                )
            )
